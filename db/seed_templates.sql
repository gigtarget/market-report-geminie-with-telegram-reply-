...
VALUES
('post_market_opening','closed','any','any','Markets are closed today — here’s the last close from {session_date}.',true,1),
('post_market_opening','closed','any','any','No trading today. Snapshot from the last session ({session_date}).',true,1),
